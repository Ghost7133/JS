    ...
    function createNewElement (){
        if (inp.value.length > 0){
            if (!massiveWork.includes(inp.value)){
                ...
                //Счет времени 
                let time = (parseInt(inpHour.value)*3600)+(parseInt(inpMinute.value)*60)+(parseInt(inpSecond.value))
                ...
                //Отрисовка элементов
                    ...
                    divText.append(text)
                    text.textContent = inp.value + " "+ ` after ${inpHour.value} Hour ${inpMinute.value} Minute ${inpSecond.value} seconds`
                ...
                //Функционал//
                    ...
                    function cancel(){
                        ...
                        if (confirm("Вы уверены что хотите удалить дело ?")){
                            ...
                            divText.removeChild(editButton)
