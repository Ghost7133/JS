...
// function generateStartGamePlate() {
//     const textForUser = document.createElement("p")
//     const userInput = document.createElement("input")
//     const containerForMenu = document.querySelector(".containerForMenu")
//     const btnInput = document.createElement("button")
//     btnInput.textContent = "Сохранить"

//     const btnOpenGamefield = document.createElement("button")
//     btnOpenGamefield.textContent = "Начать игру"

//     //Начало игры
//     btnOpenGamefield.addEventListener("click", ()=> {
//         let result = confirm("Вы хотите начать игру?")
//         result ? window.location.href = './StartGame.html' : null
//     })

//     containerForMenu.append(textForUser, userInput, btnInput, btnOpenGamefield)
//     textForUser.textContent = "Какое количетсво пар вы хотите угадывать? (от 1 до 8)"

//     //получение количества пар
//     let textFromUserInput
//     btnInput.addEventListener("click", () => {
//         if(userInput.value < 8) {
//             textFromUserInput = userInput.value
//             userInput.value = ""
//         } else {
//             alert("Введите число от 1 до 8!")
//             userInput.value = ""
//         }
//     })
//     return textFromUserInput
// }
...
function userInput() {
  ...
  if (userInputPairs <= 8 && userInputPairs != 0) {
    ...
    // После не правильного ввода ничего не выводит
    userInput();
  }
}
